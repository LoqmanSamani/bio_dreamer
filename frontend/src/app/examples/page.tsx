  ...
  return (
    <div className="section-container py-16">
      ...
      <div className="max-w-2xl mx-auto">
        <div className="card text-center py-16 border-dashed border-slate-300 dark:border-slate-700">
          ...
          <div className="grid sm:grid-cols-2 gap-4 text-left max-w-lg mx-auto mb-8">
            {[
              ...
              <div
                key={item.label}
                className="flex gap-3 p-3 rounded-xl bg-slate-100/40 dark:bg-slate-800/40"
              >
